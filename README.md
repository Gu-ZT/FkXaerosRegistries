...
**This branch targets Minecraft 1.21.7 on NeoForge.**
...
- Minecraft 1.21.7
- NeoForge 21.7.25-beta or later
...
> NeoForge never promoted a stable build for Minecraft 1.21.7, so this branch pins the newest beta, `21.7.25-beta`.
