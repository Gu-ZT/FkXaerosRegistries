...
**This branch targets Minecraft 1.21.2 on Fabric.**
...
> Xaero's Minimap and World Map have no Minecraft 1.21.2 build for Fabric. This branch is kept for completeness: it compiles, but the mod cannot load without the mods it patches, so it is not runtime-testable.
